...
namespace MobiChat.Data.Sql
{
  ...
  public class SqlConnectionInfo : SqlConnectionInfoBase
  {
    ...
    /// </summary>
    public new MobiChat.Data.Sql.Database Database
    {
      get
      {
        return base.Database as MobiChat.Data.Sql.Database;
      }
    }
    ...
    {
      return MobiChat.Data.Sql.Database.Create(true, this.Type);
    }
  }
}
