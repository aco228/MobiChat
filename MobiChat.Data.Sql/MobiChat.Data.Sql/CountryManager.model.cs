...
namespace MobiChat.Data.Sql
{
  ...
  public partial class CountryManager : MobiChat.Data.Sql.SqlManagerBase<Country>, ICountryManager
  {
    ...
    public List<Country> LoadMany(ISqlConnectionInfo connection, SqlQueryParameters parameters)
    {
      ...
      try
      {
        ...
        do
        {
					...
					Language c_lObject = (this.Depth > 0) ? c_lTable.CreateInstance() : null;
					Country cObject = (this.Depth > -1) ? cTable.CreateInstance(c_lObject) : null;
					result.Add(cObject);
