...
namespace MobiChat.Data.Sql
{
  public class CountryTable : TableBase<Country>
  {
    ...
    public class Columns
    {
			...
			public static readonly ColumnDescription GlobalName = new ColumnDescription("GlobalName", 2, typeof(string));
			public static readonly ColumnDescription LocalName = new ColumnDescription("LocalName", 3, typeof(string));
			public static readonly ColumnDescription CountryCode = new ColumnDescription("CountryCode", 4, typeof(string));
			public static readonly ColumnDescription CultureCode = new ColumnDescription("CultureCode", 5, typeof(string));
			public static readonly ColumnDescription TwoLetterIsoCode = new ColumnDescription("TwoLetterIsoCode", 6, typeof(string));
			public static readonly ColumnDescription LCID = new ColumnDescription("LCID", 7, typeof(int));
			public static readonly ColumnDescription CallingCode = new ColumnDescription("CallingCode", 8, typeof(int));
    ...
    public ColumnDescription this[int index] { get { return Columns.Item[index]; } }
	  ...
	  public Country CreateInstance()  
		{ 
			...
			return new Country(this.CountryID,(LanguageID.HasValue ? new Language(this.LanguageID.Value) : null), this.GlobalName,this.LocalName,this.CountryCode,this.CultureCode,this.TwoLetterIsoCode,this.LCID,this.CallingCode,this.Updated,this.Created); 
		}
		public Country CreateInstance(Language language)  
		{ 
			if (!this.HasData) return null;
			return new Country(this.CountryID,language ?? (this.LanguageID.HasValue ? new Language(this.LanguageID.Value) : null), this.GlobalName,this.LocalName,this.CountryCode,this.CultureCode,this.TwoLetterIsoCode,this.LCID,this.CallingCode,this.Updated,this.Created); 
		}
