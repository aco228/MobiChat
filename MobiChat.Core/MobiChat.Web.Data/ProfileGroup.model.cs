...
namespace MobiChat.Web.Data 
{
  ...
  public partial class ProfileGroup : MobiChatObject<IProfileGroupManager> 
  {
    ...
    public ProfileGroup(int id,  ProfileCategory profileCategory, Instance instance, string name, string description, DateTime updated, DateTime created): base(id, updated, created, false)
    {
    ...
    {
      return new ProfileGroup(-1,  this.ProfileCategory, this.Instance,this.Name,this.Description, DateTime.Now, DateTime.Now);
    }
  }
}
