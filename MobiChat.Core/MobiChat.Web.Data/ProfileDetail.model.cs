...
namespace MobiChat.Web.Data 
{
  ...
  public partial class ProfileDetail : MobiChatObject<IProfileDetailManager> 
  {
    ...
    public ProfileDetail(int id,  Profile profile, Language language, string name, string keyword, string description, DateTime updated, DateTime created): base(id, updated, created, false)
    {
    ...
    {
      return new ProfileDetail(-1,  this.Profile, this.Language,this.Name,this.Keyword,this.Description, DateTime.Now, DateTime.Now);
    }
  }
}
