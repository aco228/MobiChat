...
namespace MobiChat.Data 
{
  ...
  public partial class Service : MobiChatObject<IServiceManager> 
  {
    ...
    public Service(int id,  Guid guid, Application application, Product product, Merchant merchant, ServiceStatus serviceStatus, ServiceType serviceType, UserSessionType userSessionType, Country fallbackCountry, Language fallbackLanguage, ServiceConfiguration serviceConfiguration, Template template, string name, string description, DateTime updated, DateTime created): base(id, updated, created, false)
    {
			this._guid = guid;
