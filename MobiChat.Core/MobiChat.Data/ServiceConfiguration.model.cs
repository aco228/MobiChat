...
namespace MobiChat.Data 
{
  ...
  public partial class ServiceConfiguration : MobiChatObject<IServiceConfigurationManager> 
  {
		...
		public string ExternalID{ get {return this._externalID; } set { this._externalID = value;} }
    ...
    public ServiceConfiguration(int id,  int instanceID, PaymentConfiguration paymentConfiguration, string externalID, string name, DateTime updated, DateTime created): base(id, updated, created, false)
    {
    ...
    {
      return new ServiceConfiguration(-1, this.InstanceID, this.PaymentConfiguration,this.ExternalID,this.Name, DateTime.Now, DateTime.Now);
    }
  }
}
