...
namespace MobiChat.Data 
{
  ...
  public partial class UserSession : MobiChatObject<IUserSessionManager> 
  {
    ...
    {
      return new UserSession(-1, this.Guid, this.UserSessionType, this.Service, this.Domain, this.User, this.Country, this.Language, this.MobileOperator,this.TrackingID,this.IPAddress,this.UserAgent,this.EntranceUrl,this.Refferer,this.HasVerifiedAge,this.ValidUntil, DateTime.Now, DateTime.Now);
    }
  }
}
