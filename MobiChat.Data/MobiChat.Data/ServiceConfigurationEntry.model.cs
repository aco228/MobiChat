...
namespace MobiChat.Data 
{
  ...
  public partial class ServiceConfigurationEntry : MobiChatObject<IServiceConfigurationEntryManager> 
  {
		...
		public byte[] Keyword { get { return this._keyword; } set { this._keyword = value;}  }
    ...
    public ServiceConfigurationEntry(int id,  ServiceConfiguration serviceConfiguration, int countryID, int? mobileOperatorID, int shortcode, byte[] keyword, bool isAgeVerificationRequired, bool isActive, DateTime updated, DateTime created): base(id, updated, created, false)
    {
