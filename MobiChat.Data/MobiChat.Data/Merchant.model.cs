...
namespace MobiChat.Data 
{
  ...
  public partial class Merchant : MobiChatObject<IMerchantManager> 
  {
    ...
    public Merchant(int id,  Instance instance, string name, string address, string phone, string email, string registrationNo, string vatNo, DateTime updated, DateTime created): base(id, updated, created, false)
    {
    ...
    {
      return new Merchant(-1,  this.Instance,this.Name,this.Address,this.Phone,this.Email,this.RegistrationNo,this.VatNo, DateTime.Now, DateTime.Now);
    }
  }
}
